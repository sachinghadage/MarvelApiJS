...
//  If search query matches the results then it will execute next function/command.
    if(!searchQuery){
        ...
        return "http://gateway.marvel.com/v1/public/comics?ts=1&apikey=a626b5aa437ad6f953dd6a8460cf1096&hash=6d5b79bca2f0244f4c207aef2cd8cd30"
    }else{
        return `https://gateway.marvel.com:443/v1/public/characters?nameStartsWith=${searchQuery}&apikey=a626b5aa437ad6f953dd6a8460cf1096&hash=6d5b79bca2f0244f4c207aef2cd8cd30&ts=1`
    }
}
